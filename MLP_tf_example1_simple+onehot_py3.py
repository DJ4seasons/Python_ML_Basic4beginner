...
Using Tensorflow+Keras + One-Hot encoding
...
def main():
    ...
    ## Training score
    print("\nTraining Score")
    print(classification_report(lb.inverse_transform(y_train),y_pred0))
    print("Confusion matrix, without normalization")
    print(confusion_matrix(lb.inverse_transform(y_train),y_pred0).T)

    ## Test Score
    print("\nTest Score")
    print(classification_report(lb.inverse_transform(y_test),y_pred))
    cm=confusion_matrix(lb.inverse_transform(y_test),y_pred).T
